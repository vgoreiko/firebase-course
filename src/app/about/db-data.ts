...
export const COURSES: { [key: number]: Course } = {
  ...
  6: {
    ...
    longDescription:
      "Learn Web Security Fundamentals and apply them to defend an Angular /" +
        " Node Application from multiple types of attacks.",
    iconUrl:
  ...
  8: {
    ...
    longDescription:
      "Learn Advanced Angular functionality typically used in Library Development. " +
        "Advanced Components, Directives, Testing, Npm",
    iconUrl:
